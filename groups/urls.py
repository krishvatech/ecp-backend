...
from groups.views import (
    ...
    WordPressGroupSourceSyncToWordPressView,
...
urlpatterns = [
    ...
    path('groups/wordpress-sources/<int:wp_group_id>/sync-to-wordpress/', WordPressGroupSourceSyncToWordPressView.as_view(), name='wordpress-group-source-sync-to-wordpress'),
