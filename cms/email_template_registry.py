...
DEFAULT_SUBJECTS = {
    ...
    "application_accepted_applicant": "Your application to '{{ event_name }}' has been accepted",
    "application_accepted_payment_pending": "Application approved - payment pending for {{ event_name }}",
    "payment_confirmed_applicant": "Payment confirmed - you are registered for {{ event_name }}",
    "application_declined_applicant": "Your application to '{{ event_name }}' - status update",
    "application_waitlisted_applicant": "You have been waitlisted for {{ event_name }}",
    "application_reminder_to_complete": "Reminder: complete your registration for {{ event_name }}",
    "application_acknowledgement_nominator": "Nomination received for {{ event_name }}",
    "application_accepted_nominator": "Your nominee has been accepted for {{ event_name }}",
    "application_declined_nominator": "Nomination update for {{ event_name }}",
...
TEMPLATE_CATEGORIES = {
    ...
    "application_accepted_applicant": "Applications",
    "application_accepted_payment_pending": "Applications",
    "payment_confirmed_applicant": "Applications",
    "application_declined_applicant": "Applications",
    "application_waitlisted_applicant": "Applications",
    "application_reminder_to_complete": "Applications",
    "application_acknowledgement_nominator": "Applications",
    "application_accepted_nominator": "Applications",
    "application_declined_nominator": "Applications",
...
MERGE_TAG_LABELS = {
    ...
    "accepted_tier_label": "Accepted Tier Label",
...
TEMPLATE_VARIABLES = {
    ...
    "application_accepted_applicant": ["app_name", "applicant_first_name", "applicant_name", "track_label", "tier_label", "tier_price", *EVENT_CONTEXT.keys(), "support_email"],
    "application_accepted_payment_pending": ["app_name", "applicant_first_name", "applicant_name", "track_label", "accepted_tier_label", "amount_due", "currency", "payment_message", *EVENT_CONTEXT.keys(), "support_email"],
    "payment_confirmed_applicant": ["app_name", "user_first_name", "track_label", "tier_label", "amount_paid", "currency", "confirmation_message", *EVENT_CONTEXT.keys(), "support_email"],
    "application_declined_applicant": ["app_name", "applicant_first_name", "applicant_name", "track_label", "custom_message", *EVENT_CONTEXT.keys(), "support_email"],
    "application_waitlisted_applicant": ["app_name", "applicant_first_name", "applicant_name", "track_label", *EVENT_CONTEXT.keys(), "support_email"],
    "application_reminder_to_complete": ["app_name", "applicant_first_name", "applicant_name", "track_label", "completion_link", *EVENT_CONTEXT.keys(), "support_email"],
    "application_acknowledgement_nominator": ["app_name", "nominator_name", "nominee_name", "track_label", *EVENT_CONTEXT.keys(), "support_email"],
    "application_accepted_nominator": ["app_name", "nominator_name", "nominee_name", "track_label", *EVENT_CONTEXT.keys(), "support_email"],
    "application_declined_nominator": ["app_name", "nominator_name", "nominee_name", "track_label", "custom_message", *EVENT_CONTEXT.keys(), "support_email"],
...
SAMPLE_VALUES = {
    ...
    **EVENT_CONTEXT,
    ...
    "applicant_first_name": "Taylor",
    "applicant_last_name": "Morgan",
    "track_label": "Participant",
    "tier_label": "Standard",
    "accepted_tier_label": "Standard",
    "tier_price": "1200",
    "amount_due": "1200",
    "amount_paid": "1200",
    "currency": "USD",
    ...
    "nominator_name": "Jordan Lee",
    "nominee_name": "Taylor Morgan",
