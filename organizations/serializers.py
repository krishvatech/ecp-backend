...
class OrganizationSerializer(serializers.ModelSerializer):
    ...
    def validate_name(self, value: str) -> str:
        ...
        if name.isdigit():
            raise serializers.ValidationError("Organization name cannot be only numbers.")
        if not re.search(r"[A-Za-z]", name):
            raise serializers.ValidationError("Organization name must include at least one letter.")
        return name
