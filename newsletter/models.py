...
class MauticIdentityAuditLog(models.Model):
    ...
    class Action(models.TextChoices):
        ...
        TEMPLATE_CREATE = "template.create", "Template create"
        ...
        EMAIL_CREATE = "email.create", "Email broadcast create"
        EMAIL_UPDATE = "email.update", "Email broadcast update"
        EMAIL_DELETE = "email.delete", "Email broadcast delete"
