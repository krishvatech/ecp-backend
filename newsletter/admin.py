...
@admin.register(NewsletterAudience)
class NewsletterAudienceAdmin(admin.ModelAdmin):
    list_display = (
        "name",
        "audience_type",
        "status",
    ...
    list_filter = ("audience_type", "status", "is_active")
    search_fields = ("name", "description", "mautic_segment_id")
