...
MIDDLEWARE = [
    ...
    # ✅ PHASE 6: Safe Wagtail redirect middleware that skips /api/* paths
...
LIVE_JOIN_RETRY_AFTER_SECONDS = int(os.getenv("LIVE_JOIN_RETRY_AFTER_SECONDS", "1"))
LIVE_REJOIN_CONCURRENT_LIMIT = int(os.getenv("LIVE_REJOIN_CONCURRENT_LIMIT", "40"))
LIVE_REJOIN_SLOT_TTL_SECONDS = int(os.getenv("LIVE_REJOIN_SLOT_TTL_SECONDS", "30"))
LIVE_REJOIN_RETRY_AFTER_SECONDS = int(os.getenv("LIVE_REJOIN_RETRY_AFTER_SECONDS", "1"))
