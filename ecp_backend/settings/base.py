...
LIVE_JOIN_CONCURRENT_LIMIT = int(os.getenv("LIVE_JOIN_CONCURRENT_LIMIT", "60"))
LIVE_JOIN_SLOT_TTL_SECONDS = int(os.getenv("LIVE_JOIN_SLOT_TTL_SECONDS", "30"))
LIVE_JOIN_RETRY_AFTER_SECONDS = int(os.getenv("LIVE_JOIN_RETRY_AFTER_SECONDS", "2"))
LIVE_REJOIN_CONCURRENT_LIMIT = int(os.getenv("LIVE_REJOIN_CONCURRENT_LIMIT", "120"))
LIVE_REJOIN_SLOT_TTL_SECONDS = int(os.getenv("LIVE_REJOIN_SLOT_TTL_SECONDS", "30"))
LIVE_REJOIN_RETRY_AFTER_SECONDS = int(os.getenv("LIVE_REJOIN_RETRY_AFTER_SECONDS", "2"))
...
ASGI_THREADS = int(os.getenv("ASGI_THREADS", "8"))
